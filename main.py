...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'jungkook'


cars = [
   {'id':1, 'brand':'Toyota','model':'Taris Ativ','year':2024, 'price': 560000},
   {'id':2, 'brand':'Toyota','model':'Taris Cross','year':5, 'price': 860000},
   {'id':3, 'brand':'Nissan','model':'GTR','year':2024, 'price': 1560000}
]
